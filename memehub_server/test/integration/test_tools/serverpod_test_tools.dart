...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:memehub_server/src/generated/collection.dart' as _i5;
import 'package:memehub_server/src/generated/meme.dart' as _i6;
import 'package:memehub_server/src/generated/upload_description.dart' as _i7;
import 'package:memehub_server/src/generated/trending_update.dart' as _i8;
import 'package:memehub_server/src/generated/greetings/greeting.dart' as _i9;
import 'package:memehub_server/src/generated/protocol.dart';
import 'package:memehub_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _MemeEndpoint meme;

  late final _TrendingEndpoint trending;
...
class _CollectionEndpoint {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i5.Collection>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i5.Collection?> getCollection(
    _i1.TestSessionBuilder sessionBuilder,
    int collectionId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'collectionId': collectionId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i7.UploadDescription>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          endpointPath: 'meme',
          methodName: 'getMeme',
          parameters: _i1.testObjectToJson({'memeId': memeId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
...
class _TrendingEndpoint {
  ...
  _i3.Stream<_i8.TrendingUpdate> streamTrending(
    ...
    var _localTestStreamManager = _i1.TestStreamManager<_i8.TrendingUpdate>();
    _i1.callStreamFunctionAndHandleExceptions(
      () async {
        var _localUniqueSession =
            (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
              endpoint: 'trending',
              method: 'streamTrending',
            );
        var _localCallContext = await _endpointDispatch
            .getMethodStreamCallContext(
              createSessionCallback: (_) => _localUniqueSession,
              endpointPath: 'trending',
              methodName: 'streamTrending',
              arguments: {},
  ...
  _i3.Future<List<_i8.TrendingUpdate>> getTrendingSnapshot(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'trending',
            method: 'getTrendingSnapshot',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'trending',
          methodName: 'getTrendingSnapshot',
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i8.TrendingUpdate>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
